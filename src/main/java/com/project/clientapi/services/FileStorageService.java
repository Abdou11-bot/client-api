...
import com.project.clientapi.repositories.image.FileStorageException;
import com.project.clientapi.repositories.image.FileStorageProperties;
import com.project.clientapi.repositories.image.MyFileNotFoundException;
   ...
   */
    ...
    public String storeFile(MultipartFile file, Long clientId) {
        ...
        try {
            ...
            try {
                this.fileStorageLocation = Paths.get(this.pathFirstPart+'/'+clientId.toString()).toAbsolutePath().normalize();
                Files.createDirectories(this.fileStorageLocation);
            } catch (Exception ex) {
